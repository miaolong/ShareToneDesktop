...
/* SKIN && SUSE */
/* ================================ */
function skin_SUSE(wName) {
  var frame_bgcolor = "#FF0000";
  ...
  var iconpath = xDT.resPath() + 'skins/SUSE';
  ...
  return (
  			...
  			'<tr><td><img src="' + frame_dummypic + '" width="' + frame_borderwidth + '" height="' + frame_topheight + '" border="0"></td>' + 
  			     ...
  			     '<table cellpadding="0" cellspacing="0" border="0" bgcolor="#FF0000" background="' + iconpath + '/wintitlebgr.gif"><tr>' +
  			       ...
  			       '<td width="100%" align="left" valign="middle" style="color: #2E5D1B" class="' + frame_titleclass + '">&nbsp;' + xDT.prop(wName,"wTitle") + '</td>' +
...
function desktop_SUSE() {
 var iconpath = xDT.resPath() + 'skins/SUSE';
 xDT.addSkin('SUSE',0,0);
 xDT.taskbarColor("#B1C4AA","#000000",'#FFFFFF');
