/* ================================ */
/* SKIN && DESKTOP Linux GNOME	    */
/* ================================ */
function skin_GNOME(wName) {
  var frame_bgcolor = "#8C7963";
  var frame_titleclass = "xDT_wTitleB";
  var frame_borderwidth = 2;
  var frame_topheight = 23;
  var frame_bottomheight = 10;
  var frame_contentbgcolor = '#B2A499';
  var frame_dummypic = xDT.resPath() + 'images/blank.gif';
  var iconpath = xDT.resPath() + 'skins/GNOME';
  ...
  return (
  			...
  			'<table cellpadding="0" cellspacing="0" border="0" height="100% width="100%" background="' + iconpath + '/wintitlebgr.gif" >' +
  			'<tr><td><img src="' + frame_dummypic + '" width="' + frame_borderwidth + '" height="' + frame_topheight + '" border="0"></td>' + 
  			     '<td background="' + iconpath + '/wintitlebgr.gif" width="100%" align="left" valign="middle" class="' + frame_titleclass + '">' + 
...
function desktop_GNOME() {
 xDT.addSkin('GNOME',0,0);	
 xDT.taskbarColor("#948273","#ffffff","#000000");
 ...
 xDT.cbe("dDesktop").innerHtml('<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%">' +
                               '<tr><td align="left" valign="top" height="100%">' + '<img src="' + xDT.resPath() + 'skins/GNOME/gnomefoot.gif' + '" border="0"></td></tr>' +
                               '</table>');	
 xDT.cbe("dDesktop").background('#FFFFFF',xDT.resPath() + 'skins/GNOME/b_lin_gnome1.jpg');
