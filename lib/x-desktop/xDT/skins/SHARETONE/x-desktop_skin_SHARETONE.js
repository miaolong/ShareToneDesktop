...
/* ================================ */
function skin_SHARETONE(wName) {
  var frame_bgcolor = "#ff8000";
  ...
  var iconpath = xDT.resPath() + 'skins/SHARETONE';
  ...
  return (
            //'<div class="roundbox"><div class="top"><div class="bottom"><div class="left"><div class="right"><div class="bottomleft"><div class="bottomright"><div class="topleft"><div class="topright">' +
  			...
  			'<table cellpadding="0" cellspacing="0" border="0" height="100% width="100%" bgcolor="' + frame_bgcolor + '" background="' + iconpath + '/wintitlebgr.gif" >' +
  			'<tr><td><img src="' + frame_dummypic + '" width="' + frame_borderwidth + '" height="' + frame_topheight + '" border="0"></td>' + 
  			     ...
  			     '<table cellpadding="0" cellspacing="0" border="0" bgcolor="#FF8000" background="' + iconpath + '/wintitlebgr.gif"><tr>' +
  			       ...
  			       '<td class=""><a class="" href="javascript: void(0)" onmouseover="' + "SwiImg('winleft_" + wName + "','" + iconpath + "/winleft_over.gif'); " + '" ' +  'onmouseout="' + "SwiImg('winleft_" + wName + "','" + iconpath + "/winleft.gif');" + '"' + '><img name="winleft_' + wName + '" border="0" src="' + iconpath + '/winleft.gif"></a></td>' +
...
function desktop_SHARETONE() {
 var iconpath = xDT.resPath() + 'skins/SHARETONE';
 xDT.addSkin('SHARETONE',0,0);
 xDT.taskbarColor("#C99B12","#FFFFFF",'#FFFFFF');
 xDT.cbe("dDesktop").resizeTo(document.cbe.width(),document.cbe.height());
 xDT.cbe("dDesktop").innerHtml('<img src="' + iconpath + '/wallpaper.jpg" border="0" style="width: 100%; height: 100%; filter: alpha(opacity=95); -moz-opacity: .95;">');
/*
 xDT.cbe("dDesktop").innerHtml('<div style="width: 100%; height: 100%; background-image: url(' + iconpath + '\'/wintitlebgr.gif\'); filter: alpha(opacity=25); -moz-opacity: .25;"></div>');
 xDT.cbe("dDesktop").innerHtml('<img src="' + iconpath + '/wallpaper.jpg" border="0" style="width: 100%; height: 100%">');
