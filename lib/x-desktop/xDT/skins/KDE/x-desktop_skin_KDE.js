...
function skin_KDE(wName) {
  ...
  return (
  			...
  			'<tr><td><img src="' + frame_dummypic + '" width="' + frame_borderwidth + '" height="' + frame_topheight + '" border="0"></td>' + 
  			     '<td width="100%" align="left" valign="middle" class="' + frame_titleclass + '" background="' + iconpath + '/wintitlebgr.gif">' + 
  			...
  			'<tr><td><img src="' + frame_dummypic + '" width="' + frame_borderwidth + '" height="' + frame_bottomheight + '" border="0"></td><td width="100%">' + 
  			  '<table cellpadding="0" cellspacing="0">' + 
  			    '<tr>' + 
  			     '<td align="left"><img src="' + iconpath + '/winbottomleft.gif"></td>' + 
  			     '<td width="100%" background="' + iconpath + '/winbottombgr.gif"></td>' + 
  			     '<td align="right"><img src="' + iconpath + '/winbottomright.gif"></td>' + 
  			    '</tr>' + 
  			  '</table>' + 
  			'</td><td><img src="' + frame_dummypic + '" width="' + frame_borderwidth + '" height="' + frame_bottomheight + '" border="0"></td>' + 
  			'</tr></table>' +
  			'</td></tr></table>'
         );
}
function desktop_KDE() {
 var iconpath = xDT.resPath() + 'skins/KDE';
 xDT.addSkin('KDE',0,0);	
 xDT.taskbarColor("#e6e6e6","#314573","#000000");	 
 xDT.cbe("dDesktop").resizeTo(document.cbe.width(),document.cbe.height());
 xDT.cbe("dDesktop").innerHtml('<img src="' + iconpath + '/wallpaper-kde3.jpg" border="0" style="width: 100%; height: 100%">');
/*
 xDT.cbe("dDesktop").innerHtml('<table cellpadding="0" cellspacing="0" border="0" height="100%" width="100%">' +
                               '<tr><td height="100%"></td></tr>' +
                               '</table>');	
*/                               
 xDT.cbe("dDesktop").background('#314573','');	
 xDT.cbe("dDesktop").zIndex(0);
 xDT.show("dDesktop");
 //xDT.playSound(xDT.resPath() + 'sounds/kstartup.mp3');
 //document.write('<LINK REL="stylesheet" TYPE="text/css" HREF="xDT/css/KDE.css">');
}
